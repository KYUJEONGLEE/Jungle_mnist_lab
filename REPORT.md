...
### 7.0 Dropout, BatchNorm layer 순서 조정
- <img width="1582" height="983" alt="image" src="https://github.com/user-attachments/assets/4f579b12-3cf7-4666-be3f-29df73a73db4" />
- 처음에는 Dropout의 위치에 따라 최종 테스트 정확도 차이가 뚜렷하게 나타날 것으로 예상했지만, 실제 결과에서는 네 구조 간 성능 차이가 크지 않았다.
- 즉, 본 실험 조건에서는 특정 layer 순서가 압도적으로 우수하다고 보기는 어려웠다.
