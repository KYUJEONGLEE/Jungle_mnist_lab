...
- ![alt text](<Adam VS SGD acc 그래프.png>)
...
- ![alt text](<Adam VS SGD loss 그래프.png>)
...
- ![alt text](<epoch 50 lr accu 비교.png>)
...
- ![alt text](<epoch 50 lr loss 비교.png>)
